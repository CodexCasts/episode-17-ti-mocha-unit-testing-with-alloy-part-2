...
$.map_button.addEventListener('click', function(_e) {
	// we want to see what the expected payload would be so we can stub it.
//	console.log("our expected payload into map detail controller is " +JSON.stringify(args.data));
